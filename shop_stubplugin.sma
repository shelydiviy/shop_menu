...
CreateCVars()
{
    ...
    hook_cvar_change(g_sItemData[ShopItem_HP][ItemCostCvar] = create_cvar("shop_hp_cost", "2500"), "CvarChange");
    hook_cvar_change(g_sItemData[ShopItem_HE][ItemCostCvar] = create_cvar("shop_he_cost", "1000"), "CvarChange");
    hook_cvar_change(g_sItemData[ShopItem_Deagle][ItemCostCvar] = create_cvar("shop_deagle_cost", "4000"), "CvarChange");
    hook_cvar_change(g_sItemData[ShopItem_Bhop][ItemCostCvar] = create_cvar("shop_bhop_cost", "15000"), "CvarChange");

    bind_pcvar_float(create_cvar("shop_gravity_amount", "0.2"), g_sItemData[ShopItem_Gravity][ItemAmount]);
    bind_pcvar_float(create_cvar("shop_speed_amount", "350.0"), g_sItemData[ShopItem_Speed][ItemAmount]);
    bind_pcvar_num(create_cvar("shop_hp_amount", "250"), g_sItemData[ShopItem_HP][ItemAmount]);
    bind_pcvar_num(create_cvar("shop_deagle_amount", "10"), g_sItemData[ShopItem_Deagle][ItemAmount]);
}
